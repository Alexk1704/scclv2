...
--G13_layer_name            G13_DENSE       \
--G13_units                 512             \
--G13_activation            none            \
--G13_input_layer           12              \
--G14                       cl_replay.api.layer.keras.BatchNorm_Layer \
--G14_layer_name            G14_BATCHNORM   \
--G14_input_layer           13              \
--G15                       cl_replay.api.layer.keras.LeakyReLU_Layer \
--G15_layer_name            G15_LEAKYRELU   \
--G15_neg_slope             0.2             \
--G15_input_layer           14              \
--G16                       cl_replay.api.layer.keras.Dense_Layer \
--G16_layer_name            G16_DENSE       \
--G16_units                 512             \
--G16_activation            none            \
--G16_input_layer           15              \
--G17                       cl_replay.api.layer.keras.BatchNorm_Layer \
--G17_layer_name            G17_BATCHNORM   \
--G17_input_layer           16              \
--G18                       cl_replay.api.layer.keras.LeakyReLU_Layer \
--G18_layer_name            G18_LEAKYRELU   \
--G18_neg_slope             0.2             \
--G18_input_layer           17              \
--G19                       cl_replay.api.layer.keras.Dense_Layer \
--G19_layer_name            G19_OUT         \
--G19_units                 ${DATA_DIM}     \
--G19_activation            sigmoid         \
--G19_input_layer           18              \
--D_model_inputs            0 1                 \
--D_model_outputs           13                  \
--D0                        Input_Layer         \
