...
class DatasetEncoder():
    ...
    # NOTE: good reads for implementation specifics:
    ...
    We currently use an older keras_cv version of the SimCLR trainer & augmenter, 
        since we've encountered some compatibility issues with newer TF/keras versions.
    ...
    python3 $HOME/git/scclv2/src/cl_replay/api/data/encoding/DatasetEncoder.py \
        --encode_ds cifar10 \
        --encode_split train \
        --split 10 \
