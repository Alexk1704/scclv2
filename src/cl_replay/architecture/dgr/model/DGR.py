...
class DGR:
    def __init__(self, **kwargs):
        ...
        if self.generator_type == 'VAE':
            ...
            self.num_tasks          = self.parser.add_argument('--num_tasks',           type=int,   default=1, help='specify the number of total tasks')
        ...
        if self.generator_type == 'VAE':
            args = { 
                ...
                'input_size': self.input_size, 'num_classes': self.num_classes, 'num_tasks': self.num_tasks,
